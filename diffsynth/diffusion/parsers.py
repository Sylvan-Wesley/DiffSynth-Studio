...
def add_lora_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--lora_alpha", type=float, default=None, help="LoRA alpha. If omitted, defaults to --lora_rank.")
...
def add_dmd_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--dmd_cfg_scale", type=float, default=1.0, help="CFG scale used inside DMD model predictions.")
